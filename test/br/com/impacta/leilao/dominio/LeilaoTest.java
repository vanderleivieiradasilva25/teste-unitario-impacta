...
public class LeilaoTest {
	...
	public void deveReceberUmLance() {
		...
		leilao.propoe(new Lance(new Usuario("Steve Jobs"), 4000));

		assertEquals(1, leilao.getLances().size());
		assertEquals(4000, leilao.getLances().get(0).getValor(), 0.00001);
	}
	...
	public void deveReceberVariosLances() {
		Leilao leilao = new Leilao("Macbook Pro 15");
		leilao.propoe(new Lance(new Usuario("Steve Jobs"), 4000));
		leilao.propoe(new Lance(new Usuario("Steve Wozniak"), 6000));

		assertEquals(2, leilao.getLances().size());
		assertEquals(4000.0, leilao.getLances().get(0).getValor(), 0.00001);
		assertEquals(6000.0, leilao.getLances().get(1).getValor(), 0.00001);
	}
	...
	public void naoDeveAceitarTresLancesSeguidosDoMesmoUsuario() {
		...
		assertEquals(1, leilao.getLances().size());
		assertEquals(6000.0, leilao.getLances().get(0).getValor(), 0.00001);
	}
